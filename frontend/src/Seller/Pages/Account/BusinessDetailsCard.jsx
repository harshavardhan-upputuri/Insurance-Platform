...
const BusinessDetailsCard = ({ data, setData }) => {
  ...
  const handleEditSave = () => {
    if (editMode) {
      console.log("Saving business details:", data);
  ...
  return (
    <div className="bg-white w-[400px] shadow-md mx-auto rounded-lg">
      ...
      <h6 className="px-6 pt-4 font-bold text-xl">Business Details</h6>

      <div className="p-6 max-w-lg mb-6">
        {["businessName", "businessEmail", "businessMobile", "businessAddress"].map(
          (field) => (

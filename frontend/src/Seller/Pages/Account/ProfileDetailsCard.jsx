...
const ProfileDetailsCard = ({ data, setData }) => {
  ...
  return (
    <div className="bg-white w-[400px] shadow-md mx-auto rounded-lg">
      ...
      <h6 className="px-6 pt-4 font-bold text-xl">Personal Details</h6>

      <div className="p-6 rounded-lg max-w-lg mb-6">
        {["sellerName", "email", "mobile"].map((field) => (

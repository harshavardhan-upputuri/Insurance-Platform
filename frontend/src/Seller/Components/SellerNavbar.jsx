    ...
    <div className="flex flex-col w-full px-5 ">
      ...
      <div className="flex justify-between items-center p-3 w-full bg-white">
        ...
        <div className="hidden lg:flex items-center gap-6">
          ...
          {/* Auth Buttons */}
          {!sellerJwt && <div className="flex items-center justify-center">
            <button
              onClick={() => {
                handleClick(true);
                navigate("/login");
          ...
          {sellerJwt && <div className="flex flex-col items-center cursor-pointer" onClick={() => navigate("/seller")}>
            <CgProfile size={30} />
        ...
        <div className="lg:hidden flex items-center justify-between gap-4">
          ...
          {sellerJwt && <div className="cursor-pointer" onClick={() => navigate("/seller")} >
            <CgProfile size={20} />
      ...
      {menuOpen && (
        <div className="lg:hidden flex flex-col gap-4 p-4 bg-white shadow-md font-bold">
          ...
          <a href="/seller/products" className="border-b-[1px] p-1">
            Products
          </a>
          <a href="/seller/about" className="border-b-[1px] p-1">About</a>
